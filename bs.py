import os,sys,datetime,time,requests,json,random
...
def logo_taekyung():
    try:
        os.system("clear")
        mengetik(f'\033[36;1m\n\n\n\n\nSUBSCRIBE YOUTUBE KU CUY\033[37m Ezie SR  \033[36mok! :v')
        time.sleep(3)
        os.system("xdg-open https://youtube.com/channel/UCaoujPnGiWxOZAhsYR55YtA")
        time.sleep(3)
        os.system('clear')
        mengetik('\033[36;1mjoin grub \033[37;1mwa gua bor:v')
        os.system('xdg-open https://ezie100.blogspot.com/ ')
        time.sleep(3)

        os.system("clear")
        print(f"""

\033[1;0m\033[1;41m\tSPAM\033[1;0m
{putih}[\033[33;1mVersi \033[36;m1.0{putih}]
\033[33;1m╔════════════════════════════════════════════════╗
\033[33;1m║  \033[36;1m [•] mod by  : Ezie SR                     \033[33;1m   ║
\033[33;1m║  \033[36;1m [•] gitHub  : https://github.com/ezie24sr \033[33;1m   ║
\033[33;1m║  \033[36;1m [•] Youtube  : Ezie SR                     \033[33;1m  ║
\033[33;1m╚════════════════════════════════════════════════╝
\033[36;1m╔═══════════════════════════╗
\033[36;1m║\033[33;1m GUNAKAN DENGAB BJIAK CUK \033[36;1m ║
\033[36;1m╚═══════════════════════════╝
""")
    except requests.exceptions.ConnectionError:
        sys.exit(f"{W}[{R}!{W}] Cek Jaringan cuy{abu}....{abu}")
...
def put():
    ...
    try:
        ...
        for i in range(int(power_python)):
            ...
            time.sleep(3)
            url = "https://aink-sanz.herokapp.com/api/free-tutorial-spam-wa"
            AM = {
            "nomor": mr_am
            }
